...
/* 原代码使用 __packed（Keil），GCC 改为 __attribute__((packed)) */
...
/* 非阻塞 DMA 读取接口 */
extern void    BMI088_read_dma_trigger(void);
extern uint8_t BMI088_read_dma_is_ready(void);
extern void    BMI088_read_dma_get_data(fp32 gyro[3], fp32 accel[3], fp32 *temperate);
